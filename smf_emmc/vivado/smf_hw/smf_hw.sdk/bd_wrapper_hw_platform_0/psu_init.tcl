...
set psu_clock_init_data {
    ...
    mask_write 0XFF18030C 0x00040004 0x00040004
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B00004
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFFDF5
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF180320 0x33843384 0x12840280
		# : SD0 BASE CLOCK
